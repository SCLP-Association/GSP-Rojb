...
$(function() {
    ...
    $("#btnSearch").click(function(e) {
        ...
        window.location.href = WEB_URL+"stock/pembelian/material/pusat?key="+keysearch+"&from_date="+fromdate+"&to_date="+todate;
        //console.log(daterange, datesplit, datesplit1, datesplit2, fromdate, todate, keysearch);
    });

    // control modal dialog create pembelian pusat
    ...
    $("#btnInputMaterial").click(function() {
        ...
        if (noPo.length == 0) {
            $("#inputMNoPo").parent().parent().addClass("has-error");
            $("#inputMNoPo").attr("placeholder", "NO. PO HARUS DIISI");
            error = true;
        }
    ...
    $("#btnSimpanMaterial").click(function(e) {
        ...
        if (jmlMaterial == "0" || jmlMaterial == "" || jmlNilaiBeli == "0" || jmlNilaiBeli == "" || errorNilaiBeli) {
            ...
            var data = {
                ...
                tgl: $("#inputMTgl").val(),
                supplier: $("#inputMSupplier").val().toUpperCase(),
                no_po: $("#inputMNoPo").val().toUpperCase(),
                detail: arrDetail,
                token: TOKEN
            };
            ...
            console.log(data);
            $.ajax({
                url: API_URL + "stock/pembelian/material/input",
                method: "POST",
                dataType: "JSON",
