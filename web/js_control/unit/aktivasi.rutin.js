...
$(function() {
    ...
    $("#btnSearch").click(function(e) {
        ...
        window.location.href = WEB_URL+"unit/aktivasi/rutin?key="+keysearch+"&from_date="+fromdate+"&to_date="+todate;
    ...
    $(".no_kw").click(function(e) {
        ...
        window.open(WEB_URL + "unit/aktivasi/kuitansi/" + no_kuitansi, "Cetak Kuitansi", "height=650,width=850");
