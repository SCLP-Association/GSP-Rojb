          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <table class="easyui-datagrid aktivasi-table" id="tbl-material-serpo" style="height:420px;" 
                ...
                <thead frozen="true">
                  <tr>
                    <th field="dummyNoBukti" width="180" align="center"><b>NO. BUKTI</b></th>
                  </tr>
                </thead>
                <thead>
                  <tr>
                    ...
                    <th field="dummyDeskripsi" width="260" align="left">&nbsp;&nbsp;<b>DESKRIPSI</b></th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modalPembelianMaterialLabel">Input Penggunaan Material PM Baru</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal">
            <div class="box-body">
            <div class="form-group">
                <label for="inputMNoAr" class="col-sm-3 control-label"></label>

                <div class="col-sm-7">
                    <label><input type="radio" name="jenis" value="ISP" class="cb-jenis" checked/> &nbsp;ISP</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label><input type="radio" name="jenis" value="OSP" class="cb-jenis"/> &nbsp;OSP</label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                <input type="text" class="form-control" id="inputMNoBukti" placeholder="NO. BUKTI" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label for="inputMTglKuitansi" class="col-sm-3 control-label">TANGGAL</label>
            ...
            <div class="form-group">
                <label for="inputMKodeRegional" class="col-sm-3 control-label">REGIONAL</label>
            ...
            <div class="form-group" id="form-box-pop">
                <label for="inputMPop" class="col-sm-3 control-label">POP</label>

                <div class="col-sm-8">
                <select class="form-control" id="inputMPop">
                <?php foreach ($dataPop as $idx => $row) : ?>
                    <option value="<?php echo $row->kode; ?>"><?php echo $row->pop; ?></option>
                <?php endforeach; ?>
                </select>
                </div>
            </div>
            <div class="form-group" id="form-box-tikor" style="display:none;">
                <label for="inputMTikor" class="col-sm-3 control-label">TIKOR</label>

                <div class="col-sm-8">
                <input type="text" class="form-control" id="inputMTikor" placeholder="TIKOR" style="text-transform:uppercase" value="">
                </div>
            </div>
            <div class="form-group" id="form-box-lokasi" style="display:none;">
                <label for="inputMLokasi" class="col-sm-3 control-label">LOKASI</label>

                <div class="col-sm-8">
                <input type="text" class="form-control" id="inputMLokasi" placeholder="LOKASI" style="text-transform:uppercase" value="">
                </div>
            </div>
            </div>
            <!-- /.box-body -->
...
<script src="<?php echo WEB_URL; ?>js_control/unit/pm.material.js?v=<?php echo JS_VER; ?>"></script>
