<div class="row nopadding btemplate" id="b0template" style="margin-bottom:5px;">
    ...
    <div class="col-sm-7">
        <input type="text" class="form-control pull-left" style="width:520px;text-transform:uppercase;margin-right:10px;" id="keterangan" name="keterangan[]" placeholder="Keterangan">
    </div>
