        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <form class="form-horizontal form-input" id="form-aktivasi">
              <h3 class="box-title">
                <a href="<?php echo WEB_URL; ?>unit/aktivasi/rutin" class="btn btn-primary btn-sm" id="btnTutup"><i class="fa fa-fw fa-ban"></i> <span>TUTUP<span></a>
...
<script src="<?php echo WEB_URL; ?>js_control/unit/aktivasi.input.js?v=<?php echo JS_VER; ?>"></script>