<div class="row nopadding btemplate" id="b0template" style="margin-bottom:5px;">
    ...
    <div class="col-sm-7">
        <label class="control-label pull-left">&nbsp;NO. AR:&nbsp;&nbsp;</label>
        <input type="text" class="form-control pull-left" style="width:220px;margin-right:10px;" id="keterangan" name="no_ar[]" placeholder="NO. AR">

        <label class="control-label pull-left">&nbsp;REG:&nbsp;&nbsp;</label>
        <select id="regional" name="regional[]" class="form-control pull-left" style="width:220px;">
