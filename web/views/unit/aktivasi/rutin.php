        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                <a href="<?php echo WEB_URL; ?>unit/aktivasi/input" class="btn btn-primary btn-sm" id="btnInput"><i class="fa fa-fw fa-plus"></i> <span>INPUT<span></a>
              </h3>
...
<script src="<?php echo WEB_URL; ?>js_control/unit/aktivasi.rutin.js?v=<?php echo JS_VER; ?>"></script>