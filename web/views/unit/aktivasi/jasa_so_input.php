...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <li>Unit</li>
        <li>Aktivasi</li>
        <li class="active">Input Jasa SO</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <form class="form-horizontal form-input" id="form-jasa-so">
              <h3 class="box-title">
                <a href="<?php echo WEB_URL; ?>unit/aktivasi/so/jasa" class="btn btn-primary btn-sm" id="btnTutup"><i class="fa fa-fw fa-ban"></i> <span>TUTUP<span></a>
              ...
              <div id="box-form" style="margin: 15px 0 10px 0;">
                <!--<div class="box-header with-border">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                        <input type="text" class="form-control" id="inputNoso" name="no_so" placeholder="No Bukti" value="<?php echo $no_so; ?>" style="text-transform:uppercase;" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="hidden" id="inputJenis" name="jenis_jasa" value="<?php echo $dataJasa[0]->jenis; ?>"/>
                        <select class="form-control" id="inputKode" name="kode_jasa">
                            <?php foreach ($dataJasa as $id => $row): ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" id="inputPelaksana" name="pelaksana" placeholder="PELAKSANA" value="" style="text-transform:uppercase;">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                        <input type="text" class="form-control" id="inputBiaya" name="biaya" placeholder="BIAYA" value="" style="text-transform:uppercase;">
                        </div>
                    </div>
...
<script src="<?php echo WEB_URL; ?>js_control/unit/aktivasi.jasa_so_input.js?v=<?php echo JS_VER; ?>"></script>