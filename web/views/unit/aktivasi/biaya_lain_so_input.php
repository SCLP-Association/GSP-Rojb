...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <li>Unit</li>
        <li>Aktivasi</li>
        <li class="active">Input Biaya Lain SO</li>
        </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <form class="form-horizontal form-input" id="form-aktivasi">
              <h3 class="box-title">
                <a href="<?php echo WEB_URL; ?>unit/aktivasi/so/biaya_lain" class="btn btn-primary btn-sm" id="btnTutup"><i class="fa fa-fw fa-ban"></i> <span>TUTUP<span></a>
              ...
              <div id="box-form" style="margin: 15px 0 10px 0;">
                <!--<div class="box-header with-border">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                        <input type="text" class="form-control" id="inputNoso" name="no_so" placeholder="No So" value="<?php echo $no_so; ?>" style="text-transform:uppercase;" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="inputKode" name="kode_biaya">
                            <?php foreach ($dataBiaya as $id => $row): ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="col-sm-10 control-label" id="label-detail"></label>
                        </div>
                    </div>
...
<script src="<?php echo WEB_URL; ?>js_control/unit/aktivasi.biaya_lain_so_input.js?v=<?php echo JS_VER; ?>"></script>