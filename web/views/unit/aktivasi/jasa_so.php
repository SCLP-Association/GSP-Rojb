        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                <a href="<?php echo WEB_URL; ?>unit/aktivasi/so/jasa/pengeluaran" class="btn btn-primary btn-sm" id="btnInput"><i class="fa fa-fw fa-list-ul"></i> <span>PENGELUARAN JASA SO<span></a>
              </h3>
            ...
            <div class="box-body table-responsive">
              <table class="table table-hover table-bordered aktivasi-table" id="tb-ref">
                ...
                <?php $total += $row->nilai_jasa; ?>
                <tr>
                  <td class="text-center">
                    <a title="Input Jasa SO" href="<?php echo WEB_URL; ?>unit/aktivasi/so/jasa/input/<?php echo str_replace("/", "-", $row->no_so); ?>">
                        <?php echo $row->no_so; ?>
                    </a>
                  </td>
                  <td class="text-center"><?php echo toRojbDate($row->tgl); ?></td>
                  <td><?php echo $row->pekerjaan; ?></td>
                  <td class="text-right"><?php echo toRupiah($row->nilai_jasa); ?></td>
                </tr>                
                <?php endforeach; ?>
                <tr>
...
<script src="<?php echo WEB_URL; ?>js_control/unit/aktivasi.jasa_so.js?v=<?php echo JS_VER; ?>"></script>