        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                <a href="<?php echo WEB_URL; ?>unit/aktivasi/so/biaya_lain" class="btn btn-primary btn-sm" id="btnTutup"><i class="fa fa-fw fa-plus"></i> <span>TUTUP<span></a>
              </h3>
...
<script src="<?php echo WEB_URL; ?>js_control/unit/aktivasi.biaya_lain_so_pengeluaran.js?v=<?php echo JS_VER; ?>"></script>