<div class="row nopadding btemplate" id="b0template" style="margin-bottom:5px;">
    ...
    <div class="col-sm-7">
        <label class="control-label pull-left">&nbsp;NAMA:&nbsp;&nbsp;</label>
        <input type="text" class="form-control pull-left" style="width:220px;margin-right:10px;" id="nama" name="nama[]" placeholder="Nama">

        <label class="control-label pull-left">&nbsp;INST:&nbsp;&nbsp;</label>
        <input type="text" class="form-control pull-left" style="width:220px;" id="nama" name="inst[]" placeholder="Instansi">
    </div>
