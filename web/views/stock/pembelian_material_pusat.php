          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <table class="easyui-datagrid aktivasi-table" id="tbl-material-serpo" style="height:420px;" 
                ...
                <thead frozen="true">
                  <tr>
                    <th field="dummyNoBa" width="140" align="center"><b>NO. BA</b></th>
                  </tr>
                </thead>
                <thead>
                  <tr>
                    <th field="dummyTgl" width="80" align="center"><b>TANGGAL</b></th>
                    <th field="dummySupplier" width="120" align="center"><b>SUPPLIER</b></th>
                    <th field="dummyNoPo" width="120" align="center"><b>NO. PO</b></th>
                    ...
                    <th field="dummyNilai" width="140" align="right"><b>NILAI BELI</b>&nbsp;&nbsp;</th>
                  </tr>
                </thead>
                <tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modalPembelianMaterialLabel">Input Pembelian Material Pusat Baru</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal">
            ...
            <div class="form-group">
                <label for="inputMNoPo" class="col-sm-4 control-label">NO. PO</label>

                <div class="col-sm-7">
                <input type="text" class="form-control" id="inputMNoPo" placeholder="NO. PO" style="text-transform:uppercase;">
                </div>
            </div>
            </div>
            <!-- /.box-body -->
...
<script src="<?php echo WEB_URL; ?>js_control/stock/pembelian_material.pusat.js?v=<?php echo JS_VER; ?>"></script>