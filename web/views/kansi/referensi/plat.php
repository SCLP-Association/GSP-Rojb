          ...
          <div class="box">
            <div class="box-header">
              ...
              <div id="box-form" style="margin: 15px 0 10px 0;padding-top: 10px;background: #f9f9f9;">
                <div class="box-header with-border">
                    <h3 class="box-title" id="box-form-title" style="padding-left:10px;">FORM NO. PLAT</h3>
                </div>
                <form class="form-horizontal">
                    <div class="box-body">
                    <div class="form-group">
                        <label class="col-sm-1 control-label">No. Plat</label>

                        <div class="col-sm-3">
                        <input type="hidden" id="inputOldplat"/>
                        <input type="text" class="form-control" id="inputPlat" placeholder="No. Plat" style="text-transform:uppercase;" readonly>
                        </div>
                    </div>
                    </div>
                    <!-- /.box-body -->
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tb-ref">
                <tr>
                  <th style="width:15%;text-align:center;">NO. PLAT</th>
                  <th style="width:60%"></th>
                  <th></th>
                </tr>
                <?php foreach ($data as $id => $row) : ?>
                <tr>
                  <td style="text-align:center;"><span id="text-<?php echo $row->no_plat; ?>"><?php echo $row->no_plat; ?><span></td>
                  <td></td>
                  <td style="text-align:right;">
                      <button class="btn btn-default btn-xs btnRefEdit" data-kode="<?php echo $row->no_plat; ?>"><i class="fa fa-edit"></i></button>
                      <button class="btn btn-default btn-xs btnRefDelete" data-kode="<?php echo $row->no_plat; ?>"><i class="fa fa-trash-o"></i></button>
                  </td>
                </tr>
                <?php endforeach; ?>
              </table>
...
<script src="<?php echo WEB_URL; ?>js_control/kansi/referensi.plat.js?v=<?php echo JS_VER; ?>"></script>