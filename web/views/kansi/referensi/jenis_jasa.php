              ...
              <div id="box-form" style="margin: 15px 0 10px 0;padding-top: 10px;background: #f9f9f9;">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                        <input type="text" class="form-control" id="inputKode" placeholder="Kode Jasa" style="text-transform:uppercase;" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputJenis" placeholder="Jenis Jasa" style="text-transform:uppercase;">
                        </div>
                    </div>
                    <div class="form-group">
...
<script src="<?php echo WEB_URL; ?>js_control/kansi/referensi.jenis_jasa.js?v=<?php echo JS_VER; ?>"></script>