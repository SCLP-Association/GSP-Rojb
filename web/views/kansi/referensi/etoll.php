          ...
          <div class="box">
            <div class="box-header">
              ...
              <div id="box-form" style="margin: 15px 0 10px 0;padding-top: 10px;background: #f9f9f9;">
                <div class="box-header with-border">
                    <h3 class="box-title" id="box-form-title" style="padding-left:10px;">FORM NO. KARTU E-TOLL</h3>
                </div>
                <form class="form-horizontal">
                    <div class="box-body">
                    <div class="form-group">
                        <label class="col-sm-1 control-label">No. Etoll</label>

                        <div class="col-sm-3">
                        <input type="hidden" id="inputOldetoll"/>
                        <input type="text" class="form-control" id="inputEtoll" placeholder="No. E-toll" style="text-transform:uppercase;" readonly>
                        </div>
                    </div>
                    </div>
                    <!-- /.box-body -->
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tb-ref">
                <tr>
                  <th style="width:15%;text-align:center;">NO. ETOLL</th>
...
<script src="<?php echo WEB_URL; ?>js_control/kansi/referensi.etoll.js?v=<?php echo JS_VER; ?>"></script>