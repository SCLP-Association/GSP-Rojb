            ...
            <div class="box-header">
              ...
              <div id="box-form" style="margin: 15px 0 10px 0;padding-top: 10px;background: #f9f9f9;">
                <div class="box-header with-border">
                    <h3 class="box-title" id="box-form-title" style="padding-left:10px;">FORM POP</h3>
                </div>
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                        <input type="text" class="form-control" id="inputKode" placeholder="Kode POP" style="text-transform:uppercase;" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">POP</label>

                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputPop" placeholder="POP" style="text-transform:uppercase;">
                        </div>
                    </div>
                    </div>
                    <!-- /.box-body -->
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tb-ref">
                <tr>
                  ...
                  <th style="width:50%">POP</th>
                  <th></th>
                </tr>
                <?php foreach ($data as $id => $row) : ?>
                <tr>
                  <td style="text-align:center;"><?php echo $row->kode; ?></td>
                  <td><span id="text-<?php echo $row->kode; ?>"><?php echo $row->pop; ?><span></td>
                  <td style="text-align:right;">
                      <button class="btn btn-default btn-xs btnRefEdit" data-kode="<?php echo $row->kode; ?>" data-jenis="<?php echo $row->pop; ?>"><i class="fa fa-edit"></i></button>
...
<script src="<?php echo WEB_URL; ?>js_control/kansi/referensi.pop.js?v=<?php echo JS_VER; ?>"></script>