            ...
            <div class="box-header">
              ...
              <div id="box-form" style="margin: 15px 0 10px 0;padding-top: 10px;background: #f9f9f9;">
                <div class="box-header with-border">
                    <h3 class="box-title" id="box-form-title" style="padding-left:10px;">FORM MATERIAL REGIONAL</h3>
                </div>
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputKode" placeholder="Kode Material Regional" style="text-transform:uppercase;" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputNama" placeholder="nama" style="text-transform:uppercase;">
                        </div>
                    </div>
                    </div>
                    <!-- /.box-body -->
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tb-ref">
                ...
                <tr>
                  ...
                  <td><span id="text-<?php echo $row->kode; ?>"><?php echo $row->nama; ?><span></td>
                  <td style="text-align:right;">
                      <button class="btn btn-default btn-xs btnRefEdit" data-kode="<?php echo $row->kode; ?>" data-jenis="<?php echo $row->nama; ?>"><i class="fa fa-edit"></i></button>
...
<script src="<?php echo WEB_URL; ?>js_control/kansi/referensi.material_regional.js?v=<?php echo JS_VER; ?>"></script>